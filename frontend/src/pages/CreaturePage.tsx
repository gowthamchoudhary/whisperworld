    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <p className="text-slate-400">Generating unique voice and character</p>
        </div>
      </div>
    );
  }
        ...
        {imageUrl && (
          <div className="text-center">
            <img
              src={imageUrl}
              alt="Your photo"
              className="w-full max-w-sm mx-auto rounded-2xl border-2 border-emerald-500/30"
            />
          </div>
        )}
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <button
                    ...
                    className="nature-gradient rounded-xl px-6 py-3 text-white font-semibold hover:opacity-90 transition-all duration-200 flex items-center"
